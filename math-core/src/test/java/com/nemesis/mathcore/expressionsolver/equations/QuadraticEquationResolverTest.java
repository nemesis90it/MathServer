...
//
//        tests.put(new ResolutionInput("x^2+x+1", RelationalOperator.EQ), new ResolutionOutput("x", NoDelimiterInterval.Type.VOID));
//
...
//        }
//
//        public ResolutionOutput(String variable, DoublePointInterval.Type type, Component leftDelimiter, Component rightDelimiter) {
//            plainString = new DoublePointInterval(variable, type, leftDelimiter, rightDelimiter).toString();
//            latexString = new DoublePointInterval(variable, type, leftDelimiter, rightDelimiter).toLatex();
//        }
//    }
//
//    @Data
