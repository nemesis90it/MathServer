...
//        tests.put("(8*x)*(2*x+1)+1+(3*x)", "16x^2+11x+1"); // TODO: simplify with polynomials rules
...
//        tests.put("24/(2/y+3*x-2*x)", "24/(x+2/y)"); // TODO: see SumSimilarMonomial
        tests.put("-24/(2/y+3*x)", "-24/(2/y+3x)");
        tests.put("-24/-(2/y+3*x)", "24/(2/y+3x)");
        tests.put("4*x/x^2", "4/x");
        tests.put("4*(2/y)", "8/y");
        tests.put("-4*-(2/y+3*x)", "8/y+12x");
...
//        tests.put("(-(root(2-th,260)31^2))/-984", "15.747621333566882552691697793337244018333648068475282572778587979"); // TODO: FIX ROUNDING
//        tests.put("(-y)^-671/628", "");
//        tests.put("745!/(-y)^-805", "");
...
//        tests.put("x749", "");
//        tests.put("818!+639*597.9145457926439", "");
//        tests.put("(-y)ln(|-958|)/(-z)^584+y!+537*396", "");
//        tests.put("-964^(-(-948))+y!", "");
//        tests.put("0", "");
...
//        tests.put("833!/(-(-x)^36.87904379527029*270)", "");
...
//        tests.put("-(-x)^-326/578.4866150529595/(|144*198!|*-(-x)^-234.19487716350073)+579^402", "");
//        tests.put("572^x/(zz)", "");
...
//        tests.put("x/((-y)^-873.9157607681276*321)-575.1068213671902", "");
//        tests.put("-(-z)^552z", "");
//        tests.put("y+207", "");
...
//        tests.put("-z^-349.5792292596327(-(310.99394619627685*-692))^86-465-991*484^430.8699253516486", "");
//        tests.put("(-y)^-770.1002630667762/x+893.9865568043739+172!", "");
//        tests.put("-y^368*764.2077531219489", "");
//        tests.put("(-y)/332^(-z)+550", "");
//        tests.put("-(-y)^-851z!", "");
//        tests.put("893.2970867667392^856.5390362424336", "");
//        tests.put("z/(308^377*612)-337.7918833836262^334(-y)", "");
