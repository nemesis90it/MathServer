...
public class FunctionSimplifierTest {
    ...
    public void testSimplify() {
        ...
        tests.put("2(-(8y+3x))", "-6x-16y");
        tests.put("(30x)/(15x)", "2");
        tests.put("-(-log(10,x))", "log(10,x)");
        tests.put("-(1-log(10,x))", "log(10,x)-1");
        tests.put("-log(10,x)+2log(10,x)", "log(10,x)");
        tests.put("-log(10,x)^2+2log(10,x)", "-log(10,x)^2+2log(10,x)");
        tests.put("log(10,x)+2log(10,x)^2", "2log(10,x)^2+log(10,x)");
        tests.put("(30log(10,x))/(15log(10,x))", "2");
        tests.put("(30log(10,x)^2)/(15log(10,x))", "2log(10,x)");
...
//        tests.put("24/(2/y+3x-2x)", "24/(x+2/y)"); // TODO: see SumSimilarMonomial
        ...
        tests.put("-7log(10,x)+4y-2log(10,x)+2-4y", "-9log(10,x)+2");
        tests.put("-7log(10,x)+4y-2log(10,x)+2-5y+3x", "3x-y-9log(10,x)+2");
        tests.put("-7log(10,x)+4y-2log(10,x)+2-4y+3x", "3x-9log(10,x)+2");
        ...
        tests.put("x^1", "x");
        tests.put("x^0", "1");
        tests.put("x+3!-log(10,x)", "x-log(10,x)+6");
        tests.put("x+(2+1)!-log(10,x)", "x-log(10,x)+6");
        tests.put("x+(2+1)!-log(10,100)", "x+4");
        tests.put("x+(2+1)!-log(10,100)^3", "x-2");
        tests.put("log(10,x^y)", "ylog(10,x)");
        tests.put("ln(" + Constants.E_CHAR + ")", "1");
        tests.put("log(10,10)", "1");
        tests.put("log(10,1)", "0");
        tests.put("log(10,x/x)", "0");
        tests.put("8log(10,y)/(2log(10,y))", "4");
        tests.put("8x+8log(10,y)/(2log(10,y))", "8x+4");
